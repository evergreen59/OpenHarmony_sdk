...
void tmr_reset(tmr_type *tmr_x)
{
  if(tmr_x == TMR1)
  {
    crm_periph_reset(CRM_TMR1_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR1_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR2)
  {
    crm_periph_reset(CRM_TMR2_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR2_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR3)
  {
    crm_periph_reset(CRM_TMR3_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR3_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR4)
  {
    crm_periph_reset(CRM_TMR4_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR4_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR5)
  {
    crm_periph_reset(CRM_TMR5_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR5_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR6)
  {
    crm_periph_reset(CRM_TMR6_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR6_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR7)
  {
    crm_periph_reset(CRM_TMR7_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR7_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR8)
  {
    crm_periph_reset(CRM_TMR8_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR8_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR9)
  {
    crm_periph_reset(CRM_TMR9_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR9_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR10)
  {
    crm_periph_reset(CRM_TMR10_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR10_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR11)
  {
    crm_periph_reset(CRM_TMR11_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR11_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR12)
  {
    crm_periph_reset(CRM_TMR12_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR12_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR13)
  {
    crm_periph_reset(CRM_TMR13_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR13_PERIPH_RESET, AT_FALSE);
  }
  else if(tmr_x == TMR14)
  {
    crm_periph_reset(CRM_TMR14_PERIPH_RESET, AT_TRUE);
    crm_periph_reset(CRM_TMR14_PERIPH_RESET, AT_FALSE);
  }
}
...
void tmr_output_default_para_init(tmr_output_config_type *tmr_output_struct)
{
  ...
  tmr_output_struct->oc_idle_state = AT_FALSE;
  tmr_output_struct->occ_idle_state = AT_FALSE;
  tmr_output_struct->oc_polarity = TMR_OUTPUT_ACTIVE_HIGH;
  tmr_output_struct->occ_polarity = TMR_OUTPUT_ACTIVE_HIGH;
  tmr_output_struct->oc_output_state = AT_FALSE;
  tmr_output_struct->occ_output_state = AT_FALSE;
}
...
void tmr_brkdt_default_para_init(tmr_brkdt_config_type *tmr_brkdt_struct)
{
  ...
  tmr_brkdt_struct->auto_output_enable = AT_FALSE ;
  tmr_brkdt_struct->fcsoen_state = AT_FALSE ;
  tmr_brkdt_struct->fcsodis_state = AT_FALSE ;
  tmr_brkdt_struct->brk_enable = AT_FALSE ;
}
...
void tmr_base_init(tmr_type* tmr_x, uint32_t tmr_pr, uint32_t tmr_div)
{
  ...
  tmr_x->swevt_bit.ovfswtr = AT_TRUE;
}
...
{
  tmr_external_clock_config(tmr_x, es_divide, es_polarity, es_filter);
  tmr_x->stctrl_bit.ecmben = AT_TRUE;
}
