...
void system_clock_config(void)
{
  ...
  crm_clock_source_enable(CRM_CLOCK_SOURCE_HEXT, AT_TRUE);
  ...
  /* enable pll */
  crm_clock_source_enable(CRM_CLOCK_SOURCE_PLL, AT_TRUE);
  ...
  crm_auto_step_mode_enable(AT_TRUE);
  ...
  crm_auto_step_mode_enable(AT_FALSE);
