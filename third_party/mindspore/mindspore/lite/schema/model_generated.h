...
struct Primitive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const mindspore::schema::Merge *value_as_Merge() const {
    return value_type() == mindspore::schema::PrimitiveType_Merge ? static_cast<const mindspore::schema::Merge *>(value()) : nullptr;
  }
...
template<> inline const mindspore::schema::Merge *Primitive::value_as<mindspore::schema::Merge>() const {
